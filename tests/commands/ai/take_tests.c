...
Test(take_command, take_basic, .timeout = 2) {
    server_t *server = create_test_server();
...
Test(take_command, take_no_resource_on_tile, .timeout = 2) {
    server_t *server = create_test_server();
    server->game = create_test_game();
    game_t *game = server->game;
    pos_t pos = {2, 2};
...
Test(take_command, take_invalid_resource, .timeout = 2) {
    server_t *server = create_test_server();
    server->game = create_test_game();
    game_t *game = server->game;
    pos_t pos = {2, 2};
...
Test(take_command, take_success, .timeout = 2) {
    server_t *server = create_test_server();
    server->game = create_test_game();
    game_t *game = server->game;
    pos_t pos = {2, 2};
