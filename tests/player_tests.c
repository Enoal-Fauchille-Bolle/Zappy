...
// static player_t *player_in(tile_t *tile, player_t *player)
// {
...
//         return NULL;
//     }
//     return vtable->find(tile->players, predicate_function_t, player);
// }
...
Test(player, move_player_on_map)
{
    ...
    cr_assert_eq(player_at(prev_tile, 0), NULL,
